...
namespace NinjaTrader.NinjaScript.Strategies
{
    ...
    public partial class MicroPBV3 : Strategy
    {
        ...
        private void PrintDiagnostics(int minFromOpen)
        {
	        ...
	        // Base filters
	        var baseLongFilter = EnableLongs && snap.TrendUp && snap.AdxOk && !snap.VolBlocked && !pnlOrDdLock && snap.TimeOk && snap.WickOk && snap.EmaStructureOk;
	        var baseShortFilter = EnableShorts && snap.TrendDown && snap.AdxOk && !snap.VolBlocked && !pnlOrDdLock && snap.TimeOk && snap.WickOk && snap.EmaStructureOk;
