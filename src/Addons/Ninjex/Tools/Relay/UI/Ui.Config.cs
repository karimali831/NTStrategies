...
namespace NinjaTrader.NinjaScript.AddOns.Ninjex.Tools.RelayTool
{
    ...
    {
        private RelayUiConfig _lastAppliedConfig;
        ...
        private RelayUiConfig BuildConfigFromUi()
        {
        ...
        private static bool AreConfigsEqual(RelayUiConfig a, RelayUiConfig b)
        {
