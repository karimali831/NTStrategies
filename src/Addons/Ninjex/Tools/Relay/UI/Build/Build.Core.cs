...
namespace NinjaTrader.NinjaScript.AddOns.Ninjex.Tools.RelayTool
{
    public partial class RelayTool
    {
        ...
        private UIElement SafeBuildUi(RelayEngine engine)
        {
            ...
            {
                NinjexRuntime.PrintLog("BuildUi FAILED:");
                NinjexRuntime.PrintLog(ex.ToString());
                throw;
            }
        }
        
        private UIElement BuildUi(RelayEngine eng)
        {
            NinjexRuntime.PrintLog($"Relay[{_toolId}] BuildUi()");
            ...
            try
            {
                ...
                RenderRelayStatusPanel(topPanelsGrid);
